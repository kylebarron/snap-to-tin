...
import {polygon as Polygon, lineString as LineString, point as Point, feature as Feature} from '@turf/helpers';
...
function snapFeaturesToTerrain({terrain, features, viewport}) {
    var tree = constructRTree({terrain, viewport})
    var newFeatures = []
...
module.exports = {snapFeaturesToTerrain};